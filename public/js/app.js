...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cfc3479a", Component.options)
  } else {
    hotAPI.reload("data-v-cfc3479a", Component.options)
' + '  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchIndexData: function fetchIndexData() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('comments').then(function (response) {
        _this.comments = response.data.model;
    ...
    saveComment: function saveComment(comment) {
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('comments/' + comment.id, {
        'text': this.comment.new_text
      }).then(function (response) {
        //this.comments = this.comments.filter(response => comment.id = id)
        comment.editing = false;
      });
    },
    deleteComment: function deleteComment(id) {
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('comments/' + id);
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("h4", [_vm._v("Test task")]),
      _vm._v(" "),
      _vm._l(_vm.comments, function(comment) {
        return _c("div", { staticClass: "comment" }, [
          _c("h2", [_vm._v("id: " + _vm._s(comment.id))]),
          _vm._v(" "),
          _c("p", { staticClass: "comment-head" }, [
            _vm._v("username at " + _vm._s(comment.created_at))
          ]),
          _vm._v(" "),
          !comment.editing
            ? _c("p", [_vm._v("\n      " + _vm._s(comment.text) + "\n    ")])
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: comment.new_text,
                      expression: "comment.new_text"
                    }
                  ],
                  attrs: { placeholder: comment.text },
                  domProps: { value: comment.new_text },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(comment, "new_text", $event.target.value)
                    }
                  }
                })
              : _vm._e(),
        ...
        [
          _c("div", { staticClass: "form-group" }, [
            _c("textarea", {
              ...
              attrs: { id: "form", placeholder: "Type your comment..." },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cfc3479a", module.exports)
  }
}
